...
const Bistro = () => {
    return (
        <>
        <div className="bistro-bg lg:p-14 p-5 mt-10 w-full">
            <div className="bg-white flex flex-col justify-center items-center lg:p-20 rounded-xl p-5 ">
                <h1 className="text-3xl font-bold font-sans">BISTRO BOSS</h1>
